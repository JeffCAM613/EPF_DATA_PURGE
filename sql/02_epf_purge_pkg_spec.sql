...
AS
    ...
    -- ========================================================================
    -- Constants: purge mode options
    -- ========================================================================
    C_MODE_FULL       CONSTANT VARCHAR2(30) := 'FULL';
    C_MODE_CLOB_ONLY  CONSTANT VARCHAR2(30) := 'CLOB_ONLY';
    C_MODE_CLOB_N_LOGS CONSTANT VARCHAR2(30) := 'CLOB_N_LOGS';
    ...
    --   p_purge_mode      - FULL (delete rows), CLOB_ONLY (clear CLOBs, keep rows),
    --                       or CLOB_N_LOGS (clear CLOBs + full delete on LOGS)
    PROCEDURE run_purge(
